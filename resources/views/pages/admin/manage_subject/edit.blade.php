            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4 mt-2">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Edit Mata Kuliah {{ $subject->full_name }}</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <form action="{{ route('ManageSubject.update', $subject->course_code) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $subject->course_code }}" name="course_code"
                                        class="form-control">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Full Name</label>
                                    <input type="text" value="{{ $subject->full_name }}" name="full_name"
                                        class="form-control">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Nickname</label>
                                    <input type="text" value="{{ $subject->nickname }}" name="nickname"
                                        class="form-control">
                                </div>
