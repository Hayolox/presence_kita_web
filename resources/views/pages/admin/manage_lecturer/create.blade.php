                        ...
                        <div class="table-responsive">
                            <form action="{{ route('ManageLecturer.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="nip" class="form-control" name="full_name">
                                  </div>
                                <div class="mb-3">
                                  <label  class="form-label">Nama Panjang</label>
                                  <input type="text" name="full_name" class="form-control" name="full_name">
                                </div>

                                <div class="mb-3">
                                    <label  class="form-label">Username</label>
                                    <input type="text" name="username" class="form-control" name="full_name">
                                </div>
