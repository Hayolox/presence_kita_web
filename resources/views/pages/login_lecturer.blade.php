...
<body>
<form id="slick-login" action="{{ route('login.proses.lecturer') }}" method="POST">
        @csrf
        <label for="username">username</label><input type="text" name="username" class="placeholder" placeholder="udinsamsudin">
        @error('username')
